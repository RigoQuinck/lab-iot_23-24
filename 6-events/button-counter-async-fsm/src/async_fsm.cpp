 ...
 */
void InterruptDispatcher::notifyInterrupt_0() {
    interruptDispatcher.notifyInterrupt(0);
}
void InterruptDispatcher::notifyInterrupt_1() {
    interruptDispatcher.notifyInterrupt(1);
}
void InterruptDispatcher::notifyInterrupt_2() {
    interruptDispatcher.notifyInterrupt(2);
}
void InterruptDispatcher::notifyInterrupt_3() {
    interruptDispatcher.notifyInterrupt(3);
}
void InterruptDispatcher::notifyInterrupt_4() {
    interruptDispatcher.notifyInterrupt(4);
}
void InterruptDispatcher::notifyInterrupt_5() {
    interruptDispatcher.notifyInterrupt(5);
}
void InterruptDispatcher::notifyInterrupt_6() {
    interruptDispatcher.notifyInterrupt(6);
}
void InterruptDispatcher::notifyInterrupt_7() {
    interruptDispatcher.notifyInterrupt(7);
}
void InterruptDispatcher::notifyInterrupt_8() {
    interruptDispatcher.notifyInterrupt(8);
}
void InterruptDispatcher::notifyInterrupt_9() {
    interruptDispatcher.notifyInterrupt(9);
}
void InterruptDispatcher::notifyInterrupt_10() {
    interruptDispatcher.notifyInterrupt(10);
}
void InterruptDispatcher::notifyInterrupt_11() {
    interruptDispatcher.notifyInterrupt(11);
}
void InterruptDispatcher::notifyInterrupt_12() {
    interruptDispatcher.notifyInterrupt(12);
}
void InterruptDispatcher::notifyInterrupt_13() {
    interruptDispatcher.notifyInterrupt(13);
}
...
void InterruptDispatcher::bind(int pin, EventSource* src) {
    ...
    attachInterrupt(digitalPinToInterrupt(pin), notifyFunctions[pin], CHANGE);
}
